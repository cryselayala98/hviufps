...
class RegistrarHojaVida extends CI_Controller {
...
switch ($opcion) {
	...
	$data['nombre_publicacion'] =$_POST['nombreP7'];
        ...
        $data['Revista_codigo'] =$_POST['revista1'];
	...
	$data['nombre'] =$_POST['nombre9'];
        ...
        $data['Revista_codigo'] =$_POST['revista'];
	...
	$data['tipo'] =$_POST['tipo_Empresa'];
        ...
        $data['id_experiencia']= $_POST['idExperiencia']; 
	...
	$result= $this->Investigador_Model->registrar($opcion, $data);
